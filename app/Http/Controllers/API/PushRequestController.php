...
//            "servicekey" => '393311374e7640b1977f5368e3e9f13a',
        ...
        $client1 =  new Client();
        $r = $client1->request('POST', 'http://sdp.rashin.org/api/Otp/Push', ['headers' => ['Content-Type' => 'application/json', 'apikey' => '5E6FA16F-9AC6-4F70-98CA-24092D3B1030'], 'form_params' => $array, 'verify'=> false]);
